...
| [`11_generation_failure_casebook_sample.csv`](11_generation_failure_casebook_sample.csv) | 생성 실패 사례 입력 예시 |
| [`12_manual_auto_review_log.md`](12_manual_auto_review_log.md) | 수동/자동 평가 통합 로그 초안 |
| [`12_manual_auto_review_log_sample.csv`](12_manual_auto_review_log_sample.csv) | 수동/자동 평가 입력 예시 |
| [`13_release_gate_checklist.md`](13_release_gate_checklist.md) | 개선 반영 전 점검표 |
| [`13_release_gate_checklist_sample.csv`](13_release_gate_checklist_sample.csv) | 배포 게이트 점검 입력 예시 |
| [`14_weekly_quality_log_2026-W14.md`](14_weekly_quality_log_2026-W14.md) | 현재 프로젝트 기준 주간 점검 기록 초안 |
