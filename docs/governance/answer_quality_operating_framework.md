...
목적:
- `answer` 품질 개선을 데이터, 검색, 생성, 운영의 공통 프레임으로 관리한다.

## 문서 메타

| 항목 | 값 |
|---|---|
| 문서명 | answer_quality_operating_framework |
| 버전 | v0.2-draft |
| 상태 | 진행중 |
| 담당자 | 미지정 |
| 기준일 | 2026-04-01 |
